...
def update_lr(learning_rate0, epoch_num, decay_rate):
    ...
    learning_rate = np.multiply(np.divide(1,1+decay_rate*epoch_num),learning_rate0)
...
def schedule_lr_decay(learning_rate0, epoch_num, decay_rate, time_interval=1000):
    ...
    # learning_rate = ...
    # YOUR CODE STARTS HERE
    learning_rate = np.multiply(np.divide(1,1+decay_rate*np.floor(epoch_num/time_interval)),learning_rate0)
    # learning_rate = np.multiply(np.divide(1,1+decay_rate*(epoch_num//time_interval)),learning_rate0)
    # YOUR CODE ENDS HERE
    return learning_rate
